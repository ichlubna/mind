...
private:
    ...
    enum resetParameter {REASONS=0, DEPRESSION_NICE, SUICIDE_PLAN, DEPRESSION_PLAN, DEPRESSION_PRAISE, CUSTOM_THEME, DEPRESSION_MOOD, LANGUAGE, FOOD, MY_CONTACTS, DIARY, FOOD_RECORDS, SELF_HARM_HELPED, SELF_HARM_PLAN, SELF_HARM_TIMER, CONTACT_MESSAGE, SLEEP, RESET_PARAMS_COUNT};
